      ...
      d_w_dec1(nullptr), d_w_dec2(nullptr), d_w_final(nullptr)
{
    ...
    w_conv1.resize(256 * C * 3 * 3, 0.01f);      
    w_conv2.resize(128 * 256 * 3 * 3, 0.01f);    
    w_dec1.resize(128 * 128 * 3 * 3, 0.01f);     
    w_dec2.resize(256 * 128 * 3 * 3, 0.01f);     
    w_final.resize(3 * 256 * 3 * 3, 0.01f);      
    ...
    d_conv1_out = (float *)gpu_malloc(256 * H * W * sizeof(float));            
    d_pool1_out = (float *)gpu_malloc(256 * H / 2 * W / 2 * sizeof(float));    
    d_conv2_out = (float *)gpu_malloc(128 * H / 2 * W / 2 * sizeof(float));    
    d_pool2_out = (float *)gpu_malloc(128 * H / 4 * W / 4 * sizeof(float));    
    d_dec1_out = (float *)gpu_malloc(128 * H / 4 * W / 4 * sizeof(float));     
    d_ups1_out = (float *)gpu_malloc(128 * H / 2 * W / 2 * sizeof(float));     
    d_dec2_out = (float *)gpu_malloc(256 * H / 2 * W / 2 * sizeof(float));     
    d_ups2_out = (float *)gpu_malloc(256 * H * W * sizeof(float));             
